    ...
    stages {
        stage('Terraform Deployment') {
            ...
            steps {
                ...
                discordSend description: "Server Deploy", footer: "Server-Deploy-CI/CD Success", link: env.BUILD_URL, notes: sh(returnStdout: true, script: 'cat /root/tfstate/digital-ocean-servers.tfstate | jq \'.["outputs"]["ips"]["value"]\''),  link: env.BUILD_URL, result: currentBuild.currentResult, title: JOB_NAME, webhookURL: env.SOCAAS_WEBHOOK
            }
        }
    }
    post {
